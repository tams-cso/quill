...
angular.module('reg')
    ...
    .constant('DASHBOARD', {
        UNVERIFIED: 'You should have received an email asking you verify your email. (Check spam folder) Click the link in the email and you can start your application!',
        ...
        DECLINED: 'We\'re sorry to hear that you won\'t be able to make it to HackTAMS Fall 20202! :(\nMaybe next year! We hope you see you again soon.',
    })
    .constant('TEAM',{
