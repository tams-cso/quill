...
angular.module("reg").controller("ApplicationCtrl", [
  ...
  function (
    ...
    // Old code mixed with trying to allow only minors....
    function isMinor() {
    ...
    function _setupForm() {
      ...
      $(".ui.form").form({
        ...
        fields: {
          ...
          numOfHackathons: {
            identifier: "numOfHackathons",
            rules: [
              {
                type: "empty",
                prompt: "Please enter the number of hackathons you've been to.",
              },
            ],
          },
          minor: {
            ...
            rules: [
              {
                // Old code mixed with trying to allow only minors....
                type: "allowMinors",
                prompt: "You must be 13-18 years old.",
              },
            ],
          },
        },
